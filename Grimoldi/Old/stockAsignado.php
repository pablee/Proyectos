...
$db->conectar();
				...
				$query = mysqli_query($db->conexion, "SELECT * FROM stock WHERE estado = 'Asignado';")
						...
						"	
							<tr>
								...
								<td>
									...
									<input type='hidden' id='id' value='".$ver['id']."'></input>
									<input type='hidden' id='estado' value='Estado'></input>
								</td>
								<td>
									...
									<input type='hidden' id='id' value='".$ver['id']."'></input>
									<input type='hidden' id='equipo' value='Equipo'></input>
								...
								<td>
									...
									<input type='hidden' id='id' value='".$ver['id']."'></input>
									<input type='hidden' id='marca' value='Marca'></input>
								...
								<td>
									...
									<input type='hidden' id='id' value='".$ver['id']."'></input>
									<input type='hidden' id='modelo' value='Modelo'></input>
								...
								<td>
									...
									<input type='hidden' id='id' value='".$ver['id']."'></input>
									<input type='hidden' id='nro_serie' value='Nro_serie'></input>
								...
								<td>
									...
									<input type='hidden' id='id' value='".$ver['id']."'></input>
									<input type='hidden' id='sistema_operativo' value='Sistema_operativo'></input>
								...
								<td>
									...
									<input type='hidden' id='id' value='".$ver['id']."'></input>
									<input type='hidden' id='licencia' value='Licencia'></input>
								...
								<td>
									...
									<input type='hidden' id='id' value='".$ver['id']."'></input>
									<input type='hidden' id='procesador' value='Procesador'></input>
								...
								<td>
									...
									<input type='hidden' id='id' value='".$ver['id']."'></input>
									<input type='hidden' id='memoria' value='Memoria'></input>
								...
								<td>
									...
									<input type='hidden' id='id' value='".$ver['id']."'></input>
									<input type='hidden' id='hdd' value='Hdd'></input>
								...
								<td>
									...
									<input type='hidden' id='id' value='".$ver['id']."'></input>
									<input type='hidden' id='detalles' value='Detalles'></input>
								...
								<td>
									...
									<input type='hidden' id='id' value='".$ver['id']."'></input>
									<input type='hidden' id='fecha_ingreso' value='Fecha_ingreso'></input>
								...
								<td>
									...
									<input type='hidden' id='id' value='".$ver['id']."'></input>
									<input type='hidden' id='fecha_envio' value='Fecha_envio'></input>
								...
								<td>
									...
									<input type='hidden' id='id' value='".$ver['id']."'></input>
									<input type='hidden' id='deposito' value='Deposito'></input>
								...
								<td>
									...
									<input type='hidden' id='id' value='".$ver['id']."'></input>
									<input type='hidden' id='destino' value='Destino'></input>
								...
								<td>
									...
									<input type='hidden' id='id' value='".$ver['id']."'></input>
									<input type='hidden' id='sector' value='Sector'></input>
								...
								<td>
									...
									<input type='hidden' id='id' value='".$ver['id']."'></input>
									<input type='hidden' id='usuario' value='Usuario'></input>
