...
?>
<?php
//muestra los datos del registro en la tabla celulares a modificar y se muestran los campos para ingresar las modificaciones
...
<div class="col-sm-4 text-left">
	<form method = "GET" action = "php/celular/actualizarCel.php">
		<table class="table table-condensed">
							...
							<tbody>
								...
								<tr>
									...
									<td>'.$ver["linea"].'</td>
									<td>'.$ver["linea"].'</td>
									<td><input type = "hidden" name = "linea" id = "linea" value ="'.$ver["linea"].'"></input></td>
								</tr>
